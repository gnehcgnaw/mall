...
public class DynamicReportTest2 {
    ...
    public static void main(String[] args) throws Exception {
        new DynamicReportTest2().buildDynamicReport()
    ...
    public DynamicReportTest2 buildDynamicReport() throws ClassNotFoundException {
        ...
        builder.addColumn("中文", "id", Integer.class.getName(), 30, style)
                ...
                .addColumn("年龄", "age", List.class.getName(), 30, style)
                .setTitle("DynamicReport测试")
                .setUseFullPageWidth(true)
                .setPrintBackgroundOnOddRows(true);
        DynamicReportTest2 dynamicReportTest2 = new DynamicReportTest2().buildDynamicReport();
