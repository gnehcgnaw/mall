...
import com.beatshadow.mall.product.dao.AttrDao;
...
//        attrEntity.setAttrName(attr.getAttrName());
    ...
    public void updateAttr(AttrVo attr) {
        ...
        if(attrEntity.getAttrType() == ProductConstant.AttrEnum.ATTR_TYPE_BASE.getCode()){
            ...
            //判断有没有关联分组
            Integer count = attrAttrgroupRelationService.selectCount(attr.getAttrId());
            if(count>0){
                //有关联分组，就update
                ...
                //没有关联分组，就insert
                attrAttrgroupRelationService.insert(relationEntity);
            }
        }
    ...
    public PageUtils getNoRelationAttr(Map<String, Object> params, Long attrgroupId) {
        ...
        //2.2)、这些分组关联的属性
        List<AttrAttrgroupRelationEntity> groupId = attrAttrgroupRelationService.selectList(collect);
