...
public class SkuSaleAttrValueController {
    ...
    public R getSkuSaleAttrValues(@PathVariable("skuId")Long skuId){
       List<String> skuSaleAttrValueEntities =  skuSaleAttrValueService.getSkuSaleAttrValues(skuId) ;
        return R.ok().put("skuSaleAttrValueEntities", skuSaleAttrValueEntities);
    }
